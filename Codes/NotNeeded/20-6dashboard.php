            ...
            $("#getCodes").click(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var out = '<div id="tab"><table id="codes" class="table" id="codes"><thead><tr><th>Course</th><th>Group</th><th>Teacher</th><th>Code</th> <th>Used</th> <th>Time Of Using</th> <th>Actions</th></tr></thead><tbody>';
                        $.each(data['data'], function(key, value) {
                            ...
                            // out += '<input type="radio" value=' + value['id'] + ' name="city"><label class="ml-2 mr-2">' + value['name'] + '</label><br>';
                            out += '<tr id="tr' + value['id'] + '"><td>' + $("#courseName").val() + '</td><td>' + gn + '</td><td>' + $("#teacherName").val() + '</td><td>' + value['code'] + '</td><td ><button class="btn ' + used + '" id="used' + value['id'] + '" name="' + value['id'] + '" >' + text + '</button></td><td id="time' + value['id'] + '" name="' + value['id'] + '">' + time + '</td><td><button id="button' + value['id'] + '"  value="' + value['id'] + '" class="btn btn-danger">Delete</button></td></tr>';
