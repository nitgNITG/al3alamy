...
<a class="btn btn-primary" href="<?php echo $CFG->wwwroot?>/weekcodes">Add New Codes</a>
    <div class="container text-center">
        ...
        <div>
            <nav class="pagination-container row my-2">
                <button class="col pagination-button bg-warning btn mx-1 border-0" id="prev-button" aria-label="Previous page" title="Previous page">
                   Prev
                </button>           
                <div id="pagination-numbers" class="col mx-1"> </div>
                <input type="text" class="col mx-1" id="rowsCount" placeholder="عدد الاكواد المراد عرضها من  كل الكواد">
                <div class="col">
                    <span id="currentPage"></span> << <span id="pageCount"></span>
                </div>
            
                <button class="pagination-button btn col bg-warning mx-1 border-0" id="next-button" aria-label="Next page" title="Next page">
                    Next
                </button>
            </nav>     
        </div>
        ...
        <!-- Start my code -->
        <style>
            #rowsCount::placeholder{font-size:16px !important;}
            #rowsCount{
                height: 40px;
                border-radius: 0px !important;
                border: 1px solid rgb(206, 212, 218);;
                margin-bottom: 0px 5px !important;
            ...
            .pagination-button{border:none !important;}
            #pagination-numbers{display:none;}
            .active{outline:none !important;box-shadow:none !important;}
            .pagination>.active>a{background: lightseagreen !important;border-color:lightseagreen !important;outline:none !important;box-shadow:none !important;}
        </style>
        <!-- End my code -->


        <div class="row text-center justify-content-center">
            <div class="alert alert-info numbers_info col-lg-3     ml-2 mr-2" role="alert">
                Number of Total codes :
                <span id="total_codes"></span>
            </div>
            
            <div class="alert alert-info numbers_info col-lg-3 ml-2 mr-2" role="alert">
                Number of Not Used codes :
                <span id="number_of_not_used_codes"></span>
            </div>
        ...
        <div class="mb-3">
            <button type="button" class="btn btn-info" id="yesCodes">Yes</button>
            <button type="button" class="btn btn-info" id="noCodes">No</button>
            <button type="button" class="btn btn-info" id="getAllCodes">All Codes</button>
        </div>
        <div id="tab">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#getCodes").click(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var out = '<div id="tab"><table id="codes" class="table" id="codes"><thead><tr><th>Course</th><th>Group</th><th>Teacher</th><th>Code</th> <th>Used</th> <th>user who used the code</th><th>user mail</th>  <th>Time Of Using</th> <th class="no-export">Actions</th></tr></thead><tbody id="paginated-list">';
                        $.each(data['data'], function(key, value) {
                      ...
                      $.each(data['data'], function(key, value) {
                            ...
                            /* start my code */
                            function countOfNotUsed(){
                                var count = 0 ;
                                document.getElementById("number_of_not_used_codes").innerHTML = count;
                                var tableCodes = document.getElementById("codes");
                                var notUsed = tableCodes.getElementsByClassName("btn-success");
                                var count = notUsed.length ;
                                document.getElementById("number_of_not_used_codes").innerHTML = count;
                            }
                            countOfNotUsed();
                            /* end my code */
                ...
                // }
                        ...
                        setTimeout(function(){
                            ...
                            // tbody[1].setAttribute("id","paginated-list");
                            ...
                            rowsCount.addEventListener("keyup", function(event) {
                                if (event.key === "Enter") {
                                    console.log('enter pressed');
                                    rowsCount.style.display ="none";

                                    var paginationLimit = rowsCount.value ;
                                    console.log("PLimit in",paginationLimit);
                                    ////////////////
                                    // paginationLimit = 10 ;

                                    console.log("PLimit out",paginationLimit)
            ...
            /* start my code */
            $(document).on('click','button[id="yesCodes"]',function(){
                console.log('YES'); 
                // $(".btn-warning").parent().parent().css("display","table-row");
                $(".btn-success").parent().parent().css("display","none");
                ...
                setTimeout(function(){
                            ...
                            const paginationNumbers = document.getElementById("pagination-numbers");
                            const paginatedList = document.getElementById("paginated-list");
                            const listItems = paginatedList.querySelectorAll(".btn-warning");
                            const nextButton = document.getElementById("next-button");
                            const prevButton = document.getElementById("prev-button");
                            const rowsCount = document.getElementById("rowsCount");
                           
                            var paginationLimit = 10;
                            console.log("PLimit Yes Btn",paginationLimit)
                                    const pageCount = Math.ceil(listItems.length / paginationLimit);
                                    let currentPage = 1;

                                    // if(rowsCount.value !=='' && rowsCount.value > 0){
                                    //     paginationLimit = rowsCount.value ;
                                    //     console.log("paginaton limit from if",paginationLimit);
            ...
            $(document).on('click','button[id="noCodes"]',function(){
                // $(".btn-success").parent().parent().css("display","table-row");
                $(".btn-warning").parent().parent().css("display","none");
                ...
                setTimeout(function(){
                            ...
                            var paginationLimit = 10;
                            //console.log("PLimit No Btn",paginationLimit)
                                    const pageCount = Math.ceil(listItems.length / paginationLimit);
                                    let currentPage = 1;
            ...
            $("#getAllCodes").click(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#total_codes").text(data['codes']);
                        $("#number_of_used_codes").text(data['used_codes']);
                        var out = '<div id="tab"><table id="codes" class="table"><thead><tr><th>Course</th><th>Group</th><th>Teacher</th><th>Code</th> <th>Used</th> <th>user who used the code</th><th>user mail</th>  <th>Time Of Using</th> <th class="no-export">Actions</th></tr></thead><tbody>';
                        $.each(data['data'], function(key, value) {
                            if (value['groupname'] == null) {
                                gn = '-';
                            } else {
