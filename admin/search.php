...
?>
    <style>
        .secondary-navigation .navigation .nav-tabs li a[href="#linkmodules"] {
            display: none !important;
        }

        #linkroot .row:nth-child(4),
        /* Appearance row */
        #linkroot .row:nth-child(5),
        /* Default profile page and User tours */
        #linkroot .row:nth-child(7),
        /* Site home row */
        #linkroot .row:nth-child(8)
        /* Site home settings */
        {
            display: none !important;
        }

        #linkroot .container-fluid hr:nth-child(4),
        #linkroot .container-fluid hr:nth-child(3) {
            display: none !important;
        }

        ul li[data-key="grades"],
        a[href*="course/pending.php"] {
            display: none !important;
        }
    </style>
<?php
