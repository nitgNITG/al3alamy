...
*/
    ...
    function user_signup($user, $notify = true)
    {
        ...
        if (!empty($SESSION->wantsurl)) {
            set_user_preference('auth_signup_wantsurl', $SESSION->wantsurl, $user);
        }
        ...
        // create token
        /* $token = file_get_contents("" . $CFG->wwwroot . "/login/token.php?username=$user->username&password=$user->password&service=moodle_mobile_app");
        $token = json_decode($token); */
        /* $DB->insert_record('external_tokens', array('token' => $token, 'userid' => $user->id)); */
