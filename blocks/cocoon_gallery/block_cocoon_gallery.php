...
@media only screen and (max-width: 600px) {
  .main_box {grid-template-columns: 1fr;}
}
</style>
...
foreach ($files as $file) {
    ...
    if ($filename <> '.') {
        ...
        $this->content->image .= '
          <div class="main_content" data-aos="fade-up" data-aos-duration="1500">
            <div class="gallery_item">
              <img style="height: 250px;width: 100%;" class="img-fluid img-circle-rounded w100" src="' . $url . '" alt="' . $filename . '">
              <div class="gallery_overlay" style="background-color: #41454359;">
...
$this->content->text = '
<section class="about-section pb30" data-aos="fade-up" data-aos-duration="1500">
  <div class="container">';
