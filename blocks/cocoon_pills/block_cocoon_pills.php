...
class block_cocoon_pills extends block_base {
    ...
    function get_content() {
        ...
        if ($data->slidesnumber > 0) {
            $text = '			<section class="home6_about pt90 bgc-f9" style="background-color: #142052;">
            <style>
            .top_header {
              display: flex;
    ...
    <div class="overlay" style="text-align: center;">
      ...
      <div class="border" style="
        border: 8px solid #FEB62E!important;
        padding: 20px;
        color: white;
      ">
        <h5  style="
        ...
        font-size: 30px;
        color: white;
        " data-ccn="slide_title'.$i.'">'.format_text($data->$slide_title, FORMAT_HTML, array('filter' => true)).'</h5>
        <p style="padding: 20px;" data-ccn="slide_subtitle'.$i.'">'.format_text($data->$slide_subtitle, FORMAT_HTML, array('filter' => true)).'</p>
        </div>
    </div>
  </div>
</div>';
