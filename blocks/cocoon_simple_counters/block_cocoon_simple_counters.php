...
class block_cocoon_simple_counters extends block_base
{
  ...
  public function get_content()
  {
    ...
    if (!empty($this->config->counter_1_after)) {
      $this->content->counter_1_after = $this->config->counter_1_after;
    }
    ...
    if (!empty($this->config->counter_2_after)) {
      $this->content->counter_2_after = $this->config->counter_2_after;
    }
    ...
    if (!empty($this->config->counter_3_after)) {
      $this->content->counter_3_after = $this->config->counter_3_after;
    }
    ...
    if (!empty($this->config->counter_4_after)) {
      $this->content->counter_4_after = $this->config->counter_4_after;
    }
    ...
    $ex_date1 = $DB->get_field('user', 'ex_date', array('id' => $USER->id));
    $current_date = new DateTime();

    // Create a DateTime object for $ex_date
    $ex_date = new DateTime($ex_date1);
    ...
    if ($current_date < $ex_date) {
      $interval = $current_date->diff($ex_date);
        ...
        <div id="Timer" class="container">
          <div class="row mb60">
            <div class="col-lg-12 text-center mt60">
              <h3 class="fz26" data-ccn="title">' . format_text($this->content->title, FORMAT_HTML, array('filter' => true)) ." ". $ex_date1 .'</h3>
            </div>
            <div class="col-lg-10 text-center mt40 offset-lg-2">
      ...
      if (!empty($this->content->counter_1) || !empty($this->content->counter_1_text) || !empty($this->content->counter_1_icon)) {
        ...
        $this->content->text .= '
                      <div class="details">
                        ...
                        <div class="timer" data-ccn="counter_1">' . $days . '</div>';
        if (!empty($this->content->counter_1_after)) {
          $this->content->text .= '<span class="ccn-timer-after" data-ccn="counter_1_after">' . format_text($this->content->counter_1_after, FORMAT_HTML, array('filter' => true)) . '</span>';
        }
        $this->content->text .= '
                      </div>
                    </div>
      ...
      if (!empty($this->content->counter_2) || !empty($this->content->counter_2_text) || !empty($this->content->counter_2_icon)) {
        ...
        $this->content->text .= '
                      <div class="details">
                        ...
                        <div class="timer" data-ccn="counter_2">' . $hours . '</div>';
        if (!empty($this->content->counter_2_after)) {
          $this->content->text .= '<span class="ccn-timer-after" data-ccn="counter_2_after">' . format_text($this->content->counter_2_after, FORMAT_HTML, array('filter' => true)) . '</span>';
        }
        $this->content->text .= '
                      </div>
                    </div>
      ...
      if (!empty($this->content->counter_3) || !empty($this->content->counter_3_text) || !empty($this->content->counter_3_icon)) {
        ...
        $this->content->text .= '
                      <div class="details">
                        ...
                        <div class="timer" data-ccn="counter_3">' . $minutes . '</div>';
        if (!empty($this->content->counter_3_after)) {
          $this->content->text .= '<span class="ccn-timer-after" data-ccn="counter_3_after">' . format_text($this->content->counter_3_after, FORMAT_HTML, array('filter' => true)) . '</span>';
        }
        $this->content->text .= '
                      </div>
                    </div>
      ...
      if (!empty($this->content->counter_4) || !empty($this->content->counter_4_text) || !empty($this->content->counter_4_icon)) {
        ...
        $this->content->text .= '
                      <div class="details">
                        ...
                        <div class="timer" data-ccn="counter_4">' . $seconds . '</div>';
        if (!empty($this->content->counter_4_after)) {
          $this->content->text .= '<span class="ccn-timer-after" data-ccn="counter_4_after">' . format_text($this->content->counter_4_after, FORMAT_HTML, array('filter' => true)) . '</span>';
        }
        $this->content->text .= '
                      </div>
                    </div>
