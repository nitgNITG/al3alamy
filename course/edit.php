...
$video = $DB->get_record('course_promo_videos', array('course_id' => $id));
...
<?php if(!$video) { ?>
<form action="./upload_promo.php" enctype="multipart/form-data" method="post">
<!-- Pass course ID to the script -->
<input type="hidden" name="course_id" value="<?php echo $id; ?>">
<div class="form-group">
    <label class="custom-file-upload" for="fileToUpload"></label>
    <input type="file" name="fileToUpload" id="fileToUpload" class="file-input" accept=".mp4, .avi, .mov" required>
</div>
<input type="submit" value="Upload Video" name="submit" class="btn btn-primary">
</form>
...
<form action="./delete_video.php" method="get">
    ...
    <input type="hidden" name="course_id" value="<?php echo $id; ?>">
    <input type="submit" value="Delete Video" name="delete" class="btn btn-danger">
</form>
<?php } ?>
