...
class renderer extends section_renderer
{
    ...
    public function section_title($section, $course, bool $linkifneeded = true): string
    {
        ...
        foreach ($modules as $module) {
            ...
            $course_modules = $DB->get_record('course_modules', array('id' => $module->id));
                        ...
                        if (!$DB->get_record('groups_members', array('userid' => $USER->id, 'groupid' => $condition['id']))) {
                            ...
                            <div id="popupModal" class="popup-modal">
                                <div class="popup-content">
                                    ...
                                    <span class="popup-price"><span id="price"></span> LE</span>
                                    <div class="card-body d-flex flex-column" id="mycardbody">
                                      ...
                                      <form id="codeform">
                                        ...
                                        <input type="hidden" class="form-control" id="ModuleId" value="' . $course_modules->id . '">
                            ...
                            <script>
                                document.addEventListener("DOMContentLoaded", function() {
                                    ...
                                    var ModuleId2 = document.getElementById("ModuleId2").value;
                                            ...
                                            if (xhr.readyState === XMLHttpRequest.DONE) {
                                                if (xhr.status === 200) {
                                                    ...
                                                    if (response.status === "success") {
                                                        ...
                                                        setTimeout(function() {
                                                            popup.style.display = "none";
                                                            window.location.href = "' . $CFG->wwwroot . '/mod/' . $module_name . '/view.php?id=" + ModuleId;
                                            ...
                                            if (xhr.readyState === XMLHttpRequest.DONE) {
                                                if (xhr.status === 200) {
                                                    ...
                                                    if (response.status === "success") {
                                                        ...
                                                        responseMessage.textContent = response.message; // Display success message
                                                        setTimeout(function() {
                                                            window.location.href = "' . $CFG->wwwroot . '/mod/' . $module_name . '/view.php?id=" + ModuleId2;;
