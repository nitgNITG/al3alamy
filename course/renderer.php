    ...
    public function course_section_cm_name_title(cm_info $mod, $displayoptions = array())
    {
        ...
        if ($mod->uservisible) {
            ...
            .content' . $mod->id . '{
                ...
                padding: 20px;
                text-align: center;
                background-image: url(./images/code_cover.png);
        ...
        <div>
            <div class="content' . $mod->id . ' myDivs " >
                <div onclick="" class="close_btn" id="close-btn' . $mod->id . '" style="
                position: absolute;
                right: 20px;
                top: 15px;
                ...
                <div class="content_box" style="margin-top: 45px;">
                   ...
                   font-family: Amiri;">انضم إلى قبطان اللغة العربية
                   أ. عمرو أبو ناجي</h3>
                  ...
                  padding: 22px 20px !important;" type="text" class="form-control " placeholder="Add a Code" id="codeGroup2' . $mod->id . '" class="">
                  <br><br>
                  <button class="btn btn-primary" style="background-color: #FEB62E !important;
                  border: 2px solid #FEB62E !important;width: 100%;font-size: 20px;
                  font-weight: bold;" id="addCode2' . $mod->id . '">اضافة كود</button>
            ...
            <script>
                ...
                $(document).ready(function () {
                    $("#danger2' . $mod->id . '").hide();
                    $("#success2' . $mod->id . '").hide();
                    $(".content' . $mod->id . '").hide();
                    $("#' . $mod->id . '").click(function () {
                        
                        $(".myDivs").not(this).hide();
                      $("#codeGroupId2' . $mod->id . '").val($(this).attr("id"));
                        $(".content' . $mod->id . '").show();
                    });
    
                    $("#close-btn' . $mod->id . '").click(function () {
                        $(".content' . $mod->id . '").hide();
                    });
                    $("#addCode2' . $mod->id . '").click(function(){
                        var codeGroup = $("#codeGroup2' . $mod->id . '").val();
                        var mod=$("#codeGroupId2' . $mod->id . '").val();
                        console.log(mod);
                        $.ajax("/ajax.php", {
                            type: "POST",  
                            data: { group: codeGroup,userid: ' . $USER->id . ',courseGroup:' . $COURSE->id . ',clickedAct:mod},  
                            success: function (data, status, xhr) {
                                if(data == "success"){
                                    window.location.href = "' . $CFG->wwwroot . '/course/view.php?id=' . $COURSE->id . '";
                                }
                                else{
                                    if($("#success2' . $mod->id . '").is(":visible")){
                                        $("#success2' . $mod->id . '").hide();
                                    }
                                    $("#danger2' . $mod->id . '").text(data);
                                    $("#danger2' . $mod->id . '").show();
                                }
                            },
