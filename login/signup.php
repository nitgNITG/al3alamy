...
<script>
    document.addEventListener(\'DOMContentLoaded\', function () {
        ...
        emailField.addEventListener(\'input\', function () {
            ...
            var validUsername = emailValue.replace(/[^a-z0-9._@-]/g, \'\');
