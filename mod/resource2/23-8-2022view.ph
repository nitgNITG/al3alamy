    ...
    $(document).ready(function(){
        $('.qualitypick').change(function(){ 
            ...
            $(video).children().each(function(index) {
                console.log($('.qualitypick').val());
                if($('.qualitypick').val()==0){
                    $(this).attr('src','".$response['body']['files'][0]['link']."');
                }
                else if($('.qualitypick').val()==1){
                    $(this).attr('src','".$response['body']['files'][1]['link']."');
                }
                else if($('.qualitypick').val()==2){
                    $(this).attr('src','".$response['body']['files'][2]['link']."');
                }
                else if($('.qualitypick').val()==3){
                    $(this).attr('src','".$response['body']['files'][3]['link']."');

                }
                else if($('.qualitypick').val()==4){
                    $(this).attr('src','".$response['body']['files'][4]['link']."');
                }
