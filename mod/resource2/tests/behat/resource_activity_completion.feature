@mod @mod_resource2 @core_completion @_file_upload
Feature: View activity completion information for file resource2s
  In order to have visibility of file resource2 completion requirements
  As a student
  I need to be able to view my file resource2 completion progress
  ...
  Background:
    ...
    And the following config values are set as admin:
      | displayoptions | 0,1,2,3,4,5,6 | resource2 |
  ...
  Scenario: The manual completion button will be shown on the activity page and course page if Show activity completion conditions is set to Yes
    ...
    And the manual completion button for "Myfile" should exist
    And the manual completion button for "Myfile" should be disabled
    And I am on the "Myfile" "resource2 activity" page
    And the manual completion button for "Myfile" should exist
    And the manual completion button for "Myfile" should be disabled
    And I log out
    # Student view.
