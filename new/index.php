...
$courses_count = $DB->count_records_sql("SELECT COUNT(*) FROM {course} WHERE id <> 1");
...
<body id="page-top">
    ...
    <div class="content mb-4">
        ...
        <!-- All admins -->
        <div class="container mt-4">
            <h3 class="mb-4">All Admins</h3>
            <div class="row" style="row-gap: 20px;">

                <?php
                $admins = get_admins();

                // Check if the teacher is also an admin
                foreach ($admins as $admin) {

                    $ccnUserHandler = new ccnUserHandler();
                    $ccnUser = $ccnUserHandler->ccnGetUserDetails($admin->id);
                    //print_r($ccnUser);
        ...
        <div class="container mt-4">
            ...
            <div class="row" style="row-gap: 20px;">
                ...
                foreach ($teachers as $teacher) {
                    ...
                    // If the teacher is not an admin, add them to the list of non-admin teachers
                    if (!$isTeacherAdmin) {
                        $nonAdminTeachers[] = $teacher;
                    }
                }

                foreach ($nonAdminTeachers as $teacher) {
                    // Continue with your HTML code to display each non-admin teacher
                    ...
                    $profileUrl = $ccnUser->profileUrl;
                    $rawAvatar = $ccnUser->rawAvatar;
                    $ex_date = $teacher->ex_date;

                ?>
                    <div class="col-lg-4" style="flex-direction: column;">
                        <div class="user_card p-0" style="max-width: 344px !important">
                            <div class="card-image">
                                <img src="<?php echo $rawAvatar ?>" alt="Avatar"> <!-- https://images.pexels.com/photos/2746187/pexels-photo-2746187.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500 -->
                            </div>
                        ...
                        <div class="card mt-4 p-4" style="box-shadow: 0 5px 15px rgba(0, 0, 0, 0.2);">
                            <form action="./action_page.php">
                                <input type="hidden" name="user_id" id="user_id" value="<?php echo $teacher->id ?>">
                                <label for="ex_date">EX-Date:</label>
                                <input type="date" id="ex_date" value="<?php echo $ex_date; ?>" name="ex_date">
