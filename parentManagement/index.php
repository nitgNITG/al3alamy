...
$id = $_GET['id'];
$getCourseName=$DB->get_record('course',array('id'=>$id));
$enrolled_students = $DB->get_records_sql("SELECT u.id As id 
,CONCAT(u.firstname,' ',u.lastname )as fullname ,u.email, .u.phone2
FROM mo_course c 
INNER JOIN mo_context cx ON c.id = cx.instanceid 
INNER JOIN mo_role_assignments ra ON cx.id = ra.contextid AND ra.roleid = '5'
 INNER JOIN mo_user u ON ra.userid = u.id 
...
$assistants = $DB->get_records_sql("SELECT u.id As id
            FROM   mo_course c
            LEFT OUTER JOIN   mo_context cx ON c.id = cx.instanceid
            LEFT OUTER JOIN   mo_role_assignments ra ON cx.id = ra.contextid AND ra.roleid = '4'
            LEFT OUTER JOIN   mo_user u ON ra.userid = u.id 
            WHERE cx.contextlevel = '50' AND c.id= '$id'");
$teacherId = 0;
...
?>
    ...
    <div><a href="<?php echo $CFG->wwwroot;?>/course/view.php?id=<?php echo $id;?>"><?php echo $getCourseName->fullname;?></a></div>
    <div class="row">
        ...
        <button href="#" class="alert alert-secondary ml-1 mr-1"><span id="getParents">Students with Parents</span></button>
        <button href="#" class="alert alert-primary ml-1 mr-1"><span id="getNoParents">Students without Parents</span></button>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <input type="text" class="userid"disabled>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col">
                                            ...
                                            <input type="email" class="form-control" name="pEmail" id="pEmail" placeholder="Parent Email" disabled>
                                        </div>
                                    </div>
                                    <p class="error"></p>
                                    <p class="success"></p>
                    ...
                    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModal" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="myForm">
                                        <input type="text" class="userid2" disabled>
