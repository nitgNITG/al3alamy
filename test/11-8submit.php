...
Check to upload a vedio  </label>
 ...
 hi
  ...
  ';
    ...
    <button class="btn btn-warning">Your Maximum upload is 28 Mega </button>
  ...
  <select class="form-select" aria-label="Default select example" name="video_type" id="video_type_server">
  <option value="1" selected>quiz</option>
  <option value="2">Lecutre</option>
  <option value="3">Homework</option>
  <option value="4">Summary</option>
