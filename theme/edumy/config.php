...
// removed: font-awesome-animation.min (unused animated icons)
$ccnSheetsTheme[] = 'line-awesome.min';
// removed: nouislider.min (range slider, only needed in course filters)
$ccnSheetsTheme[] = 'menu';
$ccnSheetsTheme[] = 'ace-responsive-menu';
$ccnSheetsTheme[] = 'megadropdown';
$ccnSheetsTheme[] = 'bootstrap-select.min';
// removed: simplebar.min (custom scrollbar, unused)
// removed: progressbar (not needed on frontend pages)
$ccnSheetsTheme[] = 'ccn-flaticon';
$ccnSheetsTheme[] = 'flaticon';
// removed: animate (77KB AOS animations, loaded via CDN separately)
// removed: slider (carousel, not on login/home)
// removed: swiper-bundle.min (carousel, not on login/home)
// removed: magnific-popup (lightbox, not on login/home)
// removed: timecounter (countdown, rarely used)
// removed: jquery.fancybox.min (lightbox, not on login/home)
// removed: spectrum (color picker, admin only)
$ccnSheetsTheme[] = 'cocoon';
// removed: dashbord_navitaion (dashboard only)
$ccnSheetsTheme[] = 'cocoon-mdl';
// removed: cocoon-dashboard (dashboard only)
