...
$string['OnerName'] = 'Mr/Medhat Nabil';
...
/* المحفظة */
$string['wallet'] = 'محفظتي';
$string['loading_wallet_details'] = 'جاري تحميل تفاصيل المحفظة...';
$string['no_wallet_message'] = 'لا توجد لديك محفظة بعد. اضغط على الزر أدناه لإنشاء واحدة.';
$string['create_wallet_alt'] = 'إنشاء محفظة';
$string['create_wallet_button'] = 'إنشاء محفظة';
$string['recharge_balance'] = 'إعادة شحن الرصيد';
$string['enter_balance_amount'] = 'أدخل مبلغ الرصيد (جنيه)';
$string['recharge'] = 'إعادة شحن';
$string['transfer'] = 'تحويل';
$string['close'] = 'إغلاق';
$string['wallet_created_success'] = 'تم إنشاء المحفظة الجديدة بنجاح.';
$string['wallet_creation_failed'] = 'فشل في إنشاء محفظة جديدة. يرجى المحاولة مرة أخرى لاحقاً.';
$string['fetch_wallet_error'] = 'حدث خطأ أثناء جلب تفاصيل المحفظة. يرجى المحاولة مرة أخرى لاحقاً.';
$string['fetch_transactions_error'] = 'حدث خطأ أثناء جلب المعاملات. يرجى المحاولة مرة أخرى لاحقاً.';
$string['no_transactions'] = 'لا توجد معاملات.';
$string['latest_transactions'] = 'أحدث المعاملات:';
