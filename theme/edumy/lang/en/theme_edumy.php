...
$string['loading_wallet_details'] = 'Loading wallet details...';
$string['no_wallet_message'] = 'You don\'t have a wallet yet. Click the button below to create one.';
$string['create_wallet_alt'] = 'Create Wallet';
$string['create_wallet_button'] = 'Create Wallet';
$string['recharge_balance'] = 'Recharge Balance';
$string['enter_balance_amount'] = 'Enter Balance Amount (LE)';
$string['recharge'] = 'Recharge';
$string['transfer'] = 'Transfer';
$string['close'] = 'Close';
$string['wallet_created_success'] = 'New wallet created successfully.';
$string['wallet_creation_failed'] = 'Failed to create a new wallet. Please try again later.';
$string['fetch_wallet_error'] = 'An error occurred while fetching wallet details. Please try again later.';
$string['fetch_transactions_error'] = 'An error occurred while fetching transactions. Please try again later.';
$string['no_transactions'] = 'No transactions found.';
$string['latest_transactions'] = 'Latest Transactions:';
