...
<form action="index.php" method="POST">
    ...
    <div class="form-check">
        <input class="form-check-input "checked="checked" type="radio" name="checkGroup" id="checkGroup2" value="1" selected>
        ...
        $('#teacher').change(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    // console.log(data);
                    var out = '<div class="form-group><label for="">Course</label> <select class="form-control" id="jobs" required  name="course">        <option value="">Choose a Course</option>';
